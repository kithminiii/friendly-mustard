...
module.exports = {
    ...
    maintenanceTasks: async (req, res) => {
        ...
        try {
            await Project.updateAllProjectQuantities();
            logger.debug('Maintenance task: updating project quantities completed');
        } catch (err) {
            logger.error('Maintenance task: updating project quantities failed', err);
        }
        try {
